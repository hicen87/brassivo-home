...
test("macro view page is direct-file compatible and has public metadata", () => {
  ...
  assert.match(html, /styles\.css\?v=20260925media-extracted/);
  assert.doesNotMatch(html, /id="bloomberg-daily"|bloomberg-daily\.js\?v=/);
  ...
  assert.match(html, /app\.js\?v=20260925media-extracted/);
