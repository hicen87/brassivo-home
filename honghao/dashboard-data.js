(function () {
  ...
  const data = {
    ...
    changes: [
      { date: "2026-09-02", asset: "A股高久期成长 / 科创", from: "未单列", to: "承压 / 降低拥挤敞口", reason: "创业板、科创50和五个成长板块同步承压，资金转向低久期价值与防御方向。", sources: ["20260902-S1"] },
      { date: "2026-09-02", asset: "能源 / 原油", from: "事件驱动偏强 / 不追涨", to: "事件驱动偏强 / 相对受益", reason: "油价升至90至95美元区间，低战略储备放大供给冲击，能源成为风险资产中的相对例外。", sources: ["20260902-S1", "20260902-S2"] },
      { date: "2026-09-02", asset: "全球风险资产", from: "中性偏谨慎", to: "结构性谨慎 / 去久期与贝塔", reason: "金银未按避险逻辑上涨，确认市场交易的是滞胀式利率冲击；受压集中在久期、拥挤度和贝塔。", sources: ["20260902-S1", "20260902-S2"] },
