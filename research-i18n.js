(() => {
  ...
  const translations = new Map(Object.entries({
    ...
    "热度": "Heat",
    "股价观察": "Stock performance",
    "上市公司关联待核验": "Listed-company mapping unverified",
    "暂无已核验的直接上市标的": "No verified direct listed company",
    "行情待核验": "Market data unverified",
    "公司关联": "Company mapping",
    "行情复核": "Price cross-check",
    "行情来源": "Price source",
    "行情核验 ": "Prices checked ",
    "大盘来源": "Benchmark source",
    "股价观察用于筛选研究线索：比较最近完整交易日与前一交易日收盘，涨跌同时受大盘和其他消息影响，不代表这条新闻已影响定价。": "Stock performance helps screen research leads: the latest full session is compared with the prior close. Market conditions and other news also affect prices; a move does not confirm this headline affected pricing.",
